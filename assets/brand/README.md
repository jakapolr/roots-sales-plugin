...
- `LOGO roots-01.png` … `LOGO roots-05.png` — colour / white / black / grey variants
- `Roots LG-S-01.png`, `Roots LG-S-02.png` — newer signature variants
- Allowed colours only: Original (colour), White, Black, Grey

## BEECY logos
Drive folder: https://drive.google.com/drive/folders/1DqyBwr36TlZf3EXWl2_Rdz6Yz5n2M_Yc
- `AW_BEECY Logo_Primary.png` (+ `_Grey`, `_Black`)
- `BEECY_B Symbol.png` (+ `_Grey`, `_Black`, `_White`)
- `Copy of 20241111_BEECY CI Guide Book.pdf` — full guideline
- Usage rules (clear space, min size, do-nots): see references/brand-ci.md

## Proposed local layout (when downloaded)
```
assets/brand/
├── roots/   roots-logo-color.png, roots-logo-white.png, roots-logo-black.png, roots-logo-grey.png
└── beecy/   beecy-primary.png, beecy-primary-white.png, beecy-b-symbol.png, ...
```
