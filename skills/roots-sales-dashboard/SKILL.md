...
| สั่ง | Mode | คนใช้ | ตอบคำถาม |
|---|---|---|---|
| `/roots-sales-dashboard` หรือ `strategic` | 1 · Strategic | CEO / ผู้บริหาร | ทั้งปีจะถึง target ไหม |
| `/roots-sales-dashboard month` | 2 · Month close | Sales Manager | เดือนนี้ปิดเท่าไหร่ ดันดีลไหน |
| `/roots-sales-dashboard intelligence` | 3 · Intelligence | AE / SE | ดีลไหนน่าสนใจ next action คืออะไร |
